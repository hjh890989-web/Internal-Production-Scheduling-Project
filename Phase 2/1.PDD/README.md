...
| **4** | **[4.PDD_master_integrated_Opus.md](4.PDD_master_integrated_Opus.md)** | **3개 PDD 통합본 + PRD + ERD + ADR (Master)** | **Draft v1.3 (6/6 PASS)** | **SRS·구현·테스트 단일 기준 문서** (PDD + PRD + ERD + ADR + Cheatsheet) |
