...
| v1.2 | 2026-05-15 | (작성자) | **참조 문서 broken link 정정 (in-place, 콘텐츠 변경 없음)** — §참조 문서 표의 `1.process_order_consolidation.md` (Opus suffix 누락 broken link) → 실제 파일명 `1.process_order_consolidation_Opus.md`로 정정. Process ID·Version·Status 헤더 동기. **모든 BR·Activity·KPI·요건은 v1.1과 동일** — 파일 링크 정확성만 처리 |
...
| `Phase 2/1.PDD/1.process_order_consolidation_Opus.md` | 상류 PDD (수주 입력원) |
