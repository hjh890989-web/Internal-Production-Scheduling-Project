...
> **버전 주석**: v1.1 은 Sprint 20 EP-EXT-WEBHOOK (Slack/Kakao webhook, S21 와 병렬) 의 §6 장애 대응 addendum 으로 예약. S21 (마스터 운영) 이 먼저 마감되어 v1.2 로 발행. 두 sprint 완료 후 v1.3 합본 검토.
